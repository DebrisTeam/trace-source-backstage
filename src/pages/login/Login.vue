        ...
        <el-form class="form" :model="formData" ref="formData" :rules="rules">
          ...
          <el-form-item prop="password">
            ...
            <span
              ...
              v-bind:class="{ 'icon-eye-open': !eyeClose,'icon-eye-close': eyeClose }"
              v-on:click="showPassword"></span>
          </el-form-item>
        </el-form>
        <div class="block">
        ...
        rules: {
          userName: [
            { required: true, message: '用户名不能为空', trigger: 'blur' },
              { validator: checkUserName, message: '用户名不正确', trigger: 'blur, change' }
          ],
          password: [
            { required: true, message: '密码不能为空', trigger: 'blur' },
            { validator: checkpassword, message: '密码应该是6-15位的数字、字母或者下滑线',  trigger: 'blur, change' }
          ],
        }
      }
    },
...
<style scoped="scoped">
  ...
  .el-form-item.is-active .el-input__inner {
    border-color: 'green';
  }
</style>